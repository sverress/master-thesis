class HyperParameters:
    def __init__(
        ...
        DISCOUNT_RATE=0.90,
        EPSILON=0.1,
        DEFAULT_DIVIDE_GET_POSSIBLE_ACTIONS=3,
        WEIGHT_UPDATE_STEP_SIZE=0.0001,
        VEHICLE_INVENTORY_STEP_SIZE=0.25,
        WEIGHT_INITIALIZATION_VALUE=0.10,
        NUMBER_OF_ROLLOUTS=100,
        LOST_TRIP_REWARD=-10,
        DEFAULT_NUMBER_OF_NEIGHBOURS=0,
        DEFAULT_NUMBER_OF_RANDOM_NEIGHBOURS=3,
        ...
        self.DEFAULT_DIVIDE_GET_POSSIBLE_ACTIONS = DEFAULT_DIVIDE_GET_POSSIBLE_ACTIONS
        ...
        self.DEFAULT_NUMBER_OF_NEIGHBOURS = (
            DEFAULT_NUMBER_OF_NEIGHBOURS  # Zero neighbors removes neighbor filtering
        )
        self.DEFAULT_NUMBER_OF_RANDOM_NEIGHBOURS = DEFAULT_NUMBER_OF_RANDOM_NEIGHBOURS
...
VAN_BATTERY_INVENTORY = 60
VAN_SCOOTER_INVENTORY = 10
